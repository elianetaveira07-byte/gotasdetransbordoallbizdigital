    ...
    <div className="bg-guia-blue-light py-[72px]" id="familia">
      <div className="container">
        <div className="mb-12 text-center">
          <span className="text-xs font-semibold tracking-widest uppercase text-primary bg-white inline-block px-3.5 py-1.5 rounded-full mb-3.5">A família</span>
          <h2 className="font-serif text-3xl md:text-4xl font-semibold text-foreground leading-tight flex items-center justify-center gap-3">
            Matheuzinho e sua família <Heart className="w-7 h-7 text-red-500 fill-red-500" />
          </h2>
          <p className="text-guia-text-muted mt-2 max-w-lg mx-auto">Uma família unida que luta todos os dias para dar o melhor cuidado ao Matheuzinho.</p>
        </div>
