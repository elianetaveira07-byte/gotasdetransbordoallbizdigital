...
import InstitutionCard from '@/components/guia/InstitutionCard';
import CrerEmCasa from '@/components/guia/CrerEmCasa';
      ...
      <div className="bg-guia-blue-light py-[72px]" id="crer">
        <div className="container">
          ...
          <InstitutionCard
            ...
            contact={
              <>
                <a href="tel:6232323000" className="text-primary no-underline font-medium text-sm">📞 (62) 3232-3000</a>
                {' · '}
                <a href="https://wa.me/6299955400" className="text-primary no-underline font-medium text-sm">📲 WhatsApp (62) 3995-5400</a>
                <br />
      ...
      <div className="bg-guia-blue-light py-[72px]" id="pestalozzi">
        <div className="container">
          ...
          <InstitutionCard
            ...
            contact={
              <>
                <a href="tel:6235155665" className="text-primary no-underline font-medium text-sm">📞 (62) 3515-5665</a>
                <br />
      ...
      <div className="bg-guia-blue-light py-[72px]" id="apc">
        <div className="container">
          ...
          <InstitutionCard
            ...
            contact={
              <>
                <a href="https://instagram.com/apc.mais" target="_blank" rel="noreferrer" className="text-primary no-underline font-medium text-sm">📱 Instagram: @apc.mais</a>
                <br />
      ...
      <div className="container" id="adfego">
        <section className="py-[72px]">
          ...
          <InstitutionCard
            ...
            contact={
              <>
                <a href="tel:6232023313" className="text-primary no-underline font-medium text-sm">📞 (62) 3202-3313</a>
                <br />
